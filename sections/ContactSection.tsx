    ...
    <section id="contact">
      <div className=" flex flex-col gap-3 items-center justify-around px-12 lg:flex-row mt-24 mb-12">
        ...
        <form className="bg-slate-100 flex flex-col gap-5 px-5 py-12 rounded-md w-[340px] md:w-[540px] ">
          <input type="text" placeholder="Full Name" className="rounded-full p-2 w-full border border-gray-300" />
          <input type="text" placeholder="Your email" className="rounded-full p-2 w-full border border-gray-300" />
